...
for i in range(n):
	for j in range(m):
		...
		simulazione_1 = cp.fare_insieme_complessi(file_species)
		# per togliere o limitare specie nell'analisi cambiare la funzione qui sopra con quella desiderata presente in compy
